 ...
 */
public class ParametersPane extends GridPane implements IExpParameter {
	 ...
	 */
	private ParametersPane(final int level, final String title) {
	...
	/**
	 * Define a ParametersPane as Root
	 */
	...
	public boolean addExpParameter(AList<AVar> alist) {
		ParametersPane epg = new ParametersPane(level, alist.getLabel());
	...
	synchronized IExpParameter rmParameter(String name) {
