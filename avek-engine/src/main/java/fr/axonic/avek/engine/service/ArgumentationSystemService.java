...
public interface ArgumentationSystemService {
    ...
    Response constructStep(@PathParam("argumentation_system_id") String argumentationSystem,@PathParam("pattern_id") String pattern, @QueryParam("evidences") List<EvidenceRole> evidences, @QueryParam("conclusion") Conclusion conclusion);
